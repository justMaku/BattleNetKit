...
public struct Bgs_Protocol_UserManager_V1_RecentPlayer {
  ...
  public mutating func clearTimestampPlayed() {_uniqueStorage()._timestampPlayed = nil}
...
public struct Bgs_Protocol_UserManager_V1_BlockedPlayer {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Bgs_Protocol_UserManager_V1_RecentPlayer: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Bgs_Protocol_UserManager_V1_RecentPlayer, rhs: Bgs_Protocol_UserManager_V1_RecentPlayer) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._timestampPlayed != rhs_storage._timestampPlayed {return false}
...
extension Bgs_Protocol_UserManager_V1_BlockedPlayer: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Bgs_Protocol_UserManager_V1_BlockedPlayer, rhs: Bgs_Protocol_UserManager_V1_BlockedPlayer) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
