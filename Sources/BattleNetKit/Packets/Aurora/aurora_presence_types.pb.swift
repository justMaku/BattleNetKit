...
public struct Bgs_Protocol_Presence_V1_RichPresenceLocalizationKey {
...
public struct Bgs_Protocol_Presence_V1_FieldKey {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Bgs_Protocol_Presence_V1_Field {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Bgs_Protocol_Presence_V1_FieldOperation {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  /// Clears the value of `field`. Subsequent reads from it will return its default value.
  public mutating func clearField() {_uniqueStorage()._field = nil}
...
extension Bgs_Protocol_Presence_V1_FieldOperation.OperationType: CaseIterable {
  // Support synthesized by the compiler.
}

#endif  // swift(>=4.2)

public struct Bgs_Protocol_Presence_V1_PresenceState {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Bgs_Protocol_Presence_V1_ChannelState {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public mutating func clearHealing() {_uniqueStorage()._healing = nil}
...
extension Bgs_Protocol_Presence_V1_RichPresenceLocalizationKey: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Bgs_Protocol_Presence_V1_RichPresenceLocalizationKey, rhs: Bgs_Protocol_Presence_V1_RichPresenceLocalizationKey) -> Bool {
    if lhs._program != rhs._program {return false}
    if lhs._stream != rhs._stream {return false}
    if lhs._localizationID != rhs._localizationID {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Bgs_Protocol_Presence_V1_FieldKey: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Bgs_Protocol_Presence_V1_FieldKey, rhs: Bgs_Protocol_Presence_V1_FieldKey) -> Bool {
    if lhs._program != rhs._program {return false}
...
extension Bgs_Protocol_Presence_V1_Field: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Bgs_Protocol_Presence_V1_Field, rhs: Bgs_Protocol_Presence_V1_Field) -> Bool {
...
extension Bgs_Protocol_Presence_V1_FieldOperation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Bgs_Protocol_Presence_V1_FieldOperation, rhs: Bgs_Protocol_Presence_V1_FieldOperation) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Bgs_Protocol_Presence_V1_PresenceState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Bgs_Protocol_Presence_V1_PresenceState, rhs: Bgs_Protocol_Presence_V1_PresenceState) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Bgs_Protocol_Presence_V1_ChannelState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Bgs_Protocol_Presence_V1_ChannelState, rhs: Bgs_Protocol_Presence_V1_ChannelState) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._entityID != rhs_storage._entityID {return false}
        if _storage._fieldOperation != rhs_storage._fieldOperation {return false}
        if _storage._healing != rhs_storage._healing {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
