...
public struct Bgs_Protocol_EntityId {
...
public struct Bgs_Protocol_Identity {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Bgs_Protocol_EntityId: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Bgs_Protocol_EntityId, rhs: Bgs_Protocol_EntityId) -> Bool {
...
extension Bgs_Protocol_Identity: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Bgs_Protocol_Identity, rhs: Bgs_Protocol_Identity) -> Bool {
