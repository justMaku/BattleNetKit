...
// Source: GetLicensesResponse.proto
//
...
public struct GetLicensesResponse: SwiftProtobuf.Message {
  public static let protoMessageName: String = "GetLicensesResponse"
...
extension GetLicensesResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "licenses"),
  ]

  public func _protobuf_generated_isEqualTo(other: GetLicensesResponse) -> Bool {
