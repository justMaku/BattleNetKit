...
extension Bgs_Protocol_InvitationRemovedReason: CaseIterable {
...
extension Bgs_Protocol_SuggestionRemovedReason: CaseIterable {
  // Support synthesized by the compiler.
}

#endif  // swift(>=4.2)

public struct Bgs_Protocol_Invitation: SwiftProtobuf.ExtensibleMessage {
  ...
  public mutating func clearInvitationMessage() {_uniqueStorage()._invitationMessage = nil}
...
public struct Bgs_Protocol_InvitationParams: SwiftProtobuf.ExtensibleMessage {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Bgs_Protocol_Invitation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Bgs_Protocol_Invitation, rhs: Bgs_Protocol_Invitation) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._invitationMessage != rhs_storage._invitationMessage {return false}
...
extension Bgs_Protocol_InvitationParams: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Bgs_Protocol_InvitationParams, rhs: Bgs_Protocol_InvitationParams) -> Bool {
    if lhs._invitationMessage != rhs._invitationMessage {return false}
