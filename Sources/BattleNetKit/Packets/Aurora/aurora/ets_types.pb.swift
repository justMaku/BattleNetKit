...
public struct Bgs_Protocol_TimeSeriesId: SwiftProtobuf.Message {
...
extension Bgs_Protocol_TimeSeriesId: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "epoch"),
    2: .same(proto: "position"),
  ]

  public func _protobuf_generated_isEqualTo(other: Bgs_Protocol_TimeSeriesId) -> Bool {
